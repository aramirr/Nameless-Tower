...
function RespawnOnLevel2()
	...
	lm:delete_grass(18, false)
	lm:delete_grass(18, true)
	lm:delete_grass(19, false)
	lm:delete_grass(19, true)
...
function OnLevel1Start()
	...
	lm:play_animation("Peke_Twerk", 7, 0, true)
	lm:play_animation("Peke_Ska", 7, 0, true)
	lm:play_animation("Peke_Saltitos1", 5, 0, true)
	lm:play_animation("Peke_Saltitos2", 5, 0, true)
	lm:play_animation("Peke_Pescador", 4, 0, true)
	lm:play_animation("Peke_Colgado2", 6, 0, true)
	lm:play_animation("Peke_Colgado1", 3, 0, true)
	lm:play_animation("Peke_Bracitos", 2, 0, true)
	lm:play_animation("Peke_Aplausos_Sentado1", 1, 0, true)
	lm:play_animation("Peke_Aplausos_Sentado2", 1, 0, true)
	lm:play_animation("Peke_Aplausos", 0, 0, true)

	lm:activate_cinematic_bands(false)
	lm:pause_player()
	lm:activate_cinematic("cinematica_inicial", false)	
	lm:play_animation_player(32)
	lm:play_delayed_sound(0, "cinematica_intro")
	lm:regain_control(24)
	lm:play_delayed_sound(24, "musica_outside")
	--lm:regain_control(1)
...
function OnTriggerExitTSCinematicaFinal()
	...
	lm:play_delayed_sound(0, "musica_final_boss")
	lm:play_delayed_sound(0, "cinematica_final_boss")
	lm:play_animation_player(35)
	lm:regain_control(14)
	lm:set_runner_int(false)
	lm:set_runner_int(true)
	lm:play_animation("Boss", 1, 0, false)
...
function OnTriggerExitTPTutorialEstatua()
	...
	lm:insert_grass(18, true)
	lm:insert_grass(19, true)
...
function OnTriggerExitTSPuertasArbol()
	...
	lm:deactivate_iluminacion_viento(false)
	lm:play_interior_sound(false)
	...
	lm:activate_iluminacion_viento(true)
