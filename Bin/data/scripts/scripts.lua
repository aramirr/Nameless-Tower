...
function OnTriggerExitTSArbolRunner()
	...
	lm:set_dir_light_intensity("LightInteriorSCaldero", 0, true)
	lm:activate_cinematic("cinematic_vientos", true)
	lm:play_ambient_sound(true)
	...
	lm:set_dir_light_intensity("LightInteriorSCaldero", 3.6, false)
end
...
function OnTriggerExitTSRunnerCascada()
	...
	lm:set_dir_light_intensity("LightInteriorSCaldero", 3.6, true)
	lm:play_interior_sound(true)
	...
	lm:set_dir_light_intensity("LightInteriorSCaldero", 0, false)
