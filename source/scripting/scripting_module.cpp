...
void ScriptingModule::BootLuaSLB(SLB::Manager *m)
{
    ...
    .set("play_sound", &LogicManager::playSound)
		...
		.set("activate_camara_bajada", &LogicManager::activateCamaraBajada)
		.set("deactivate_camara_bajada", &LogicManager::desactivateCamaraBajada)
		.set("activate_iluminacion_viento", &LogicManager::activateIluminacionViento)
		.set("deactivate_iluminacion_viento", &LogicManager::desactivateIluminacionViento)
