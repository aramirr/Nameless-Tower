...
void CAIBossRunner::Init()
{
	...
	AddState("idle", (statehandler)&CAIBossRunner::idle_state);
...
void CAIBossRunner::registerMsgs() {
	...
	DECL_MSG(CAIBossRunner, TMsgRunnerAppear, appear);
	DECL_MSG(CAIBossRunner, TMsgRunnerStop, stop);
}
